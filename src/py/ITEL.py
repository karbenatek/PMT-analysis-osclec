...
class ITEL():
    ...
    def ACQ_MainBoard(self):
        ...
        time_fine0_cal = pd.read_csv("./TDC_calibration/TDC_CalibratedOutputs_Channel0.csv")  # CHANGE PATH AS NEEDED
        time_fine1_cal = pd.read_csv("./TDC_calibration/TDC_CalibratedOutputs_Channel1.csv")  # CHANGE PATH AS NEEDED
