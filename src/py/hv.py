...
class HighVoltageApp(cmd2.Cmd):
   ...
   def __init__(self, port):
      ...
      self.port = port
      self.allow_style = cmd2.ansi.ANSI_STYLE_RE
   ...
   bright_black = functools.partial(cmd2.ansi.style, fg=cmd2.ansi.Fg.BLACK)
   bright_yellow = functools.partial(cmd2.ansi.style, fg=cmd2.ansi.Fg.YELLOW)
   bright_green = functools.partial(cmd2.ansi.style, fg=cmd2.ansi.Fg.GREEN)
   bright_red = functools.partial(cmd2.ansi.style, fg=cmd2.ansi.Fg.RED)
   bright_cyan= functools.partial(cmd2.ansi.style, fg=cmd2.ansi.Fg.CYAN)
   bright_blue = functools.partial(cmd2.ansi.style, fg=cmd2.ansi.Fg.BLUE)
   yellow = functools.partial(cmd2.ansi.style, fg=cmd2.ansi.Fg.YELLOW)
   blue = functools.partial(cmd2.ansi.style, fg=cmd2.ansi.Fg.BLUE)
   alarm_red = functools.partial(cmd2.ansi.style, fg=cmd2.ansi.Fg.WHITE, bg=cmd2.ansi.Bg.RED)
